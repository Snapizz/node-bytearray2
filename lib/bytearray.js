...
var ByteArray = (function () {
    ...
    ByteArray.prototype.writeBytes = function (bytes, offset, length) {
        ...
        bytes.position = 0;
        var nsize = length - this.bytesAvailable;
    ...
    ByteArray.prototype.writeDouble = function (value) {
        var position = this.updatePosition(8, true);
        return this.endian === Endian.Big
            ? this.buffer.writeDoubleBE(value, position)
            : this.buffer.writeDoubleBE(value, position);
    };
    ByteArray.prototype.writeFloat = function (value) {
        var position = this.updatePosition(4, true);
        return this.endian === Endian.Big
    ...
    ByteArray.prototype.writeShort = function (value) {
        var position = this.updatePosition(2, true);
        return this.endian === Endian.Big
    ...
    ByteArray.prototype.resize = function (size) {
        var ba = new ByteArray(size || this.position);
        ba.writeBytes(this);
    ...
    ByteArray.fromArray = function (array) {
        var ba = new ByteArray(array.length);
    ...
    ByteArray.prototype.updatePosition = function (n, write) {
        if (write) {
        }
        var a = this.position;
        this.position += n;
    ...
    ByteArray.prototype.resizeBeforeWrite = function (n) {
        var size = this.position + n;
        if (size >= this.length) {
            this.resize(size);
        }
    };
